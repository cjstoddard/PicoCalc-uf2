...
GUI GAUGE #4,85,130,60,BLK,BLK,0,120,1,"F",YLW,60,GRN,90,RED
' If you want temperature in Celsius, Comment out the previous line
' and uncomment the next line.
'GUI GAUGE #4,85,130,60,BLK,BLK,0,100,1,"C",YLW,15,GRN,32,RED
GUI GAUGE #5,235,130,60,BLK,BLK,0,100,1,"%",YLW,30,GRN,60,RED
