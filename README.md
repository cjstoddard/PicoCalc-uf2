...
Update 4-10-2025
I added Picocalc-ed.bas. This is a crud text line editor that handles 20 lines. This can be changed, but 20 lines works best for the PicoCalc. I have no idea why someone would use this, but sinse someone was making an MP3 player, I figured a text editor was not an enirtely stupid idea. Writing a full screen editor is impractical in PicoBasic and if you need one, the built in edtor is perfectly functional.
